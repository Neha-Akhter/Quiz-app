...
public class Trigonometry extends AppCompatActivity implements View.OnClickListener {
    ...
    private void get_question_list()
    {
        ...
        questionsList.add(new Questions(getString(R.string.Question1T) , getString(R.string.Option1_1T), getString(R.string.Option2_1T) ,getString(R.string.Option3_1T),getString(R.string.Option4_1T),2));
        questionsList.add(new Questions(getString(R.string.Question2T) , getString(R.string.Option1_2T), getString(R.string.Option2_2T) ,getString(R.string.Option3_2T),getString(R.string.Option4_2T),4));
        questionsList.add(new Questions(getString(R.string.Question3T) , getString(R.string.Option1_3T), getString(R.string.Option2_3T) ,getString(R.string.Option3_3T),getString(R.string.Option4_3T),3));
        questionsList.add(new Questions(getString(R.string.Question4T) , getString(R.string.Option1_4T), getString(R.string.Option2_4T) ,getString(R.string.Option3_4T),getString(R.string.Option4_4T),1));
        questionsList.add(new Questions(getString(R.string.Question5T) , getString(R.string.Option1_5T), getString(R.string.Option2_5T) ,getString(R.string.Option3_5T),getString(R.string.Option4_5T),3));
        questionsList.add(new Questions(getString(R.string.Question6T) , getString(R.string.Option1_6T), getString(R.string.Option2_6T) ,getString(R.string.Option3_6T),getString(R.string.Option4_6T),1));
        questionsList.add(new Questions(getString(R.string.Question7T) , getString(R.string.Option1_7T), getString(R.string.Option2_7T) ,getString(R.string.Option3_7T),getString(R.string.Option4_7T),2));
        questionsList.add(new Questions(getString(R.string.Question8T) , getString(R.string.Option1_8T), getString(R.string.Option2_8T) ,getString(R.string.Option3_8T),getString(R.string.Option4_8T),2));
    ...
    private void change_question(){
        if (current_ques_no < questionsList.size()-1){
            ...
            // Show score now
            Intent intent = new Intent(Trigonometry.this, Score_Activity.class);
